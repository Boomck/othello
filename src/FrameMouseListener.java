...
public class FrameMouseListener extends JFrame implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        Chess.X = (e.getX())/50;
        Chess.Y = (e.getY())/50;
        if(Chess.base[Chess.Y][Chess.X]==2 && Chess.round == 1)
        {
            ...
            ////重新统计棋盘中黑白子数量
        }else if(Chess.base[Chess.Y][Chess.X]==-2 && Chess.round == -1)
        {
            Chess.base[Chess.Y][Chess.X]=-1;
            pd.changechess(Chess.base,Chess.X,Chess.Y,Chess.round);
        ...
        //打印棋盘及下棋方
        printchess();
        System.out.println(Chess.round+""+Chess.round+""+Chess.round+""+Chess.round+""+Chess.round+""+Chess.round+""+Chess.round);
    }
    ...
    public void banbug(){//防止无子可下的情况
        ...
        {
            JOptionPane.showMessageDialog(null,"chufa");
